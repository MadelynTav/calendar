...
public class CalendarPrinter
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The number of days in the month is ");
    ...
    public static void printMonthCalendar(Calendar date)
    {
        ...
        if(dayInMonth == (date.get(Calendar.DAY_OF_MONTH))) ;
        System.out.println("*");

        System.out.println(monthName + date.get(Calendar.YEAR));
